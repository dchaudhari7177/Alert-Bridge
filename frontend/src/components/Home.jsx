...
const Home = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-blue-500 to-teal-400">
        ...
        <section className="w-full md:w-3/4 lg:w-2/3 grid grid-cols-1 sm:grid-cols-3 gap-6 mt-10 mb-4">
          <div className="bg-white shadow-lg rounded-lg p-4 transition-transform duration-300 transform hover:scale-105 animate-fadeIn">
            ...
            <div className="flex justify-center gap-4">
              <a href="https://www.linkedin.com/in/founder1" target="_blank" rel="noopener noreferrer" className="text-[#0077B6] hover:text-[#005f8f]">
                <FaLinkedin className="w-6 h-6 transition-transform duration-300 transform hover:scale-125" />
              </a>
              <a href="https://github.com/founder1" target="_blank" rel="noopener noreferrer" className="text-[#0077B6] hover:text-[#005f8f]">
                <FaGithub className="w-6 h-6 transition-transform duration-300 transform hover:scale-125" />
              </a>
              <a href="https://instagram.com/founder1" target="_blank" rel="noopener noreferrer" className="text-[#0077B6] hover:text-[#005f8f]">
